(function() {
  ...
  function flameGraph() {
    ...
    var w = 0.9*window.innerWidth, // graph width
      h = 0.3*window.innerHeight, // graph height
      c = 18, // cell height
    ...
    var colorMapper = function(d) {
        ...
        var part = d.total / 13;
        var colorId = Math.round((d.total / d.value) - 1) % 13;
        var colors = ["#d35339", "#c35831", "#e8793e", "#d77d31", "#cd7f32", "#ffa474", "#faa76c", "#ffb961", "#ffcc99", "#ffdead", "#ffe2b7", "#eee8aa", "#fdeaa8"];
        // console.log(d.value, d.total, colorId, colors[colorId]);
    	return colors[colorId];
        // d.highlight ? "#E600E6" : colorHash(d.name); 
    };
